    ...
    const checkProfanityHateSpeech = async () => {
        ...
        await axios.post('http://localhost:8000/api/profanity_hate_speech_check/', {
            ...
            if (response.data.is_profanity_or_hate_speech) {
                ...
                output.innerHTML = "The string does not contain profanity or hate speech."
            }
        })
    }
                ...
                <div className='flex-1 min-h-screen flex flex-col gap-y-16 px-8 py-12 w-1/2'>
                    <div className='flex flex-col gap-y-3'>
                        <div className='bg-body dark:bg-font flex flex-col gap-y-3'>
                            ...
                            <h3> Testing the application of GPT-3 to find hate speech and profanity.</h3>
                            <p>Enter a sentence and click submit to check if the string contains profanity or hate speech. Individudal character and words might not work.</p>
                            <input type="text" id="input" name="input" placeholder="Enter a string" className='border-2 border-body dark:border-font p-2 text-black' />
                            <button onClick={() => {
                                checkProfanityHateSpeech()

                            }} className='bg-green-500 text-white rounded-lg p-2'>Submit</button>
                    ...
                    <h6>**Disclamier** This is only for testing. It might generate inconsitent results.</h6>
