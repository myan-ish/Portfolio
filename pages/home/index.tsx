        ...
        <>
            ...
            <div className='w-full flex flex-row'>
                ...
                <div className='flex-1 min-h-screen flex flex-col gap-y-16 px-8 py-12'>
                    <div className='bg-body dark:bg-font flex flex-row gap-y-3'>

                        <div className='flex flex-row gap-y-4'>
                            <div className='h-96 rounded-md overflow-auto bg-gradient-to-r from-indigo-500 w-3/4'>
                                <h1>Hello, I am Manish, a backend developer with 1 year of experience.</h1>
                                <p>In my free time, I solve issues on Github, help newbies on discord and learning is always fun.</p></div>
                        </div>
                    </div>
